...
- VGG16[^5]: [models/vgg.py](models/vgg.py)
- ResNet34, ResNet50[^6]: [models/resnet.py](models/resnet.py)
...
[^5]: [Simonyan, Karen, and Andrew Zisserman. "Very Deep Convolutional Networks for Large-Scale Image Recognition." 3rd International Conference on Learning Representations (ICLR 2015), 2015, pp. 1-14.](https://arxiv.org/abs/1409.1556)
[^6]: [He, Kaiming, et al. "Deep Residual Learning for Image Recognition." 2016 IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2016, pp. 770-78.](https://arxiv.org/abs/1512.03385)
